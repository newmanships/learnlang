...
class AlphabetsControllerTest < ActionController::TestCase
  ...
  test "should create alphabet" do
    assert_difference('Alphabet.count') do
      post :create, alphabet: { course_id: @alphabet.course_id, explanation: @alphabet.explanation, symbol: @alphabet.symbol }
    end
  ...
  test "should update alphabet" do
    patch :update, id: @alphabet, alphabet: { course_id: @alphabet.course_id, explanation: @alphabet.explanation, symbol: @alphabet.symbol }
    assert_redirected_to alphabet_path(assigns(:alphabet))
  end
