...
class UserAnswersControllerTest < ActionController::TestCase
  ...
  test "should create user_answer" do
    assert_difference('UserAnswer.count') do
      post :create, user_answer: { attempt_id: @user_answer.attempt_id, question_id: @user_answer.question_id, userAnswerText: @user_answer.userAnswerText, user_id: @user_answer.user_id }
    end
  ...
  test "should update user_answer" do
    patch :update, id: @user_answer, user_answer: { attempt_id: @user_answer.attempt_id, question_id: @user_answer.question_id, userAnswerText: @user_answer.userAnswerText, user_id: @user_answer.user_id }
    assert_redirected_to user_answer_path(assigns(:user_answer))
  end
